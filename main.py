...
# This function should check if there is any lower case letter so the change to be made is isupper() --> islower()
...
# Password must be atleast 8 characters so >= 7 should be changed to > 7.
